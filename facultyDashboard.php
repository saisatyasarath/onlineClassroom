...
<div class="jumbotron">
<h1>Welcome to Gudimetla Classroom<button class="btn" id = "myBtn" style="margin-left: 350px; margin-bottom: 10px;"><i class="fa fa-plus"></i></button></h1>              
</div>
</div>
...
<div class="card-group">
  	...
  	<?php
        ...
        while($rows = $result->fetch_assoc()){
            ...
            <div class="card-body ">
            <h5 class="card-title">Subject : '.$rows['cname'].'</h5>
            <p class="card-text"><h5>Code is : '.$rows['ccode'].'</h5></p>
            <p class="card-text text1"><h5><label class="pc">Faculty :'.$rows['fid'].'</label></h5></p> 
            </div>';
            echo '</div>';
            echo '</a>';
            echo '</div>';
